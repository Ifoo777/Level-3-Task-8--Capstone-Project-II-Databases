...
public class Main {
    ...
    /** Initialize the scannner function for the user to take in an input */
          ...
          do {
            ...
            + "0. Exit");
             ...
             String userChoice = userInput.nextLine();
              ...
              //Switch statement to execute a method given by the user
             switch(userChoice){
                ...
                case "2":
                    ...
                    Architect.createNewArchitect(statement, architectName);
                     break;
    ...
    public static void updateInformation(Statement statement) throws SQLException {
		...
		switch (itemUpdate) {
            ...
            /**
                ...
                switch (itemUpdate) {
                    ...
                    case "1":
                        // Search by project Number
                            ...
                            ResultSet showProjectByNumberElse = statement.executeQuery("SELECT * FROM Project WHERE ProjectNumber =" + projectNumber);
                    ...
                    case "2":
                        ...
                        if (projectByName.next() == true) {
                            ...
                            ResultSet showProjectByNameElse = statement.executeQuery("SELECT * FROM Project WHERE ProjectName = '" + projectName + "'");
                    ...
                    case "3":
					        ...
					        int confirmSeeProjects = userInput.nextInt();
					        userInput.nextLine();
                        ...
                        case "4":
					        // Confirm if user wants to see all the detailed linked Projects
					    System.out.println(
							"\nAre you sure you want to show all the Detailed linked Projects? \n1. YES \n2. NO");
					        int confirmSeeProjectsDetailed = userInput.nextInt();
					        userInput.nextLine();
                    ...
                    case "5":
					    ...
					    ResultSet resultShowArchitect = statement.executeQuery("SELECT * FROM Architect WHERE Name = '" + architectName + "'");
				...
				case "6":
                        ...
                        int confirmSeeArchitect = userInput.nextInt();
                        userInput.nextLine();
                ...
                case "7":
					...
					ResultSet resultShowContractor = statement.executeQuery("SELECT * FROM Contractor WHERE Name = '" + contractorName + "'");
                ...
                case "8":
					...
					int confirmSeeContractor = userInput.nextInt();
					userInput.nextLine();
				...
				case "10":
					...
					int confirmSeeCustomer = userInput.nextInt();
					userInput.nextLine();
					...
					ResultSet showProjectByFinalised = statement.executeQuery("SELECT * FROM Project WHERE Finalised =" + projectFinalised);
				...
				case "12":
					...
					ResultSet showProjectByNotFinalised = statement.executeQuery("SELECT * FROM Project WHERE Finalised =" + projectNotFinalised);
					displayProjectResults(showProjectByNotFinalised);
					break;

				case "13":
					// All project that is past due date and not finalized
					ResultSet showProjectPastDue = statement.executeQuery("SELECT * FROM Project WHERE Deadline < DATE(NOW()) AND Finalised = FALSE");
	...
	public static void displayFullProjectResults(ResultSet results) throws SQLException {
			...
			System.out.println(results.getString("Customer.Name") + ", " + results.getInt("Customer.Telephone") + ", " + results.getString("Customer.Email") + ", " + results.getString("Customer.Address"));
		}
	} 
	 /**
	...
	*/
	public static void displayContactDetailsResults(ResultSet results) throws SQLException {
		...
		// Display selected data rows
		    while (results.next()) {
			System.out.println(results.getString("Name") + ", " + results.getInt("Telephone") + ", " + results.getString("Email") + ", " + results.getString("Address"));
		}
	}
